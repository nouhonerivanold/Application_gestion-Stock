...
<head>
    ...
    <script src="../Javascript/Produits.js" defer></script>
...
<body>
        ...
        <div class="Header">
            <div class="search-bar">
                <div class="search-content">
                    <input type="text" id="searchInput" placeholder="rechercher un Produits">
    ...
    <div id="modalClient" class="modal">  
        <div class="form-container">
            ...
            <h2>Ajout produit</h2>
            <form id="productForm" action="../../Controleur/ajout_produit.php" method="POST" enctype="multipart/form-data">
            <label for="libelle">Libelle produit</label>
            <input type="text" id="libelle" name="libelle" placeholder="entrez le libelle du produit" required>

            <label for="prix">Prix unitaire</label>
            <input type="number" id="prix" name="prix" placeholder="500" required>
            ...
            <label for="stock_min">Quantité minimale</label>
            <input type="text" id="stock_min" name="stock_min" placeholder="stock minimal d'alerte" required>
            ...
            <div class="button-group">
                ...
                <button type="button" class="btn btn-annuler" onclick="resetForm()">Annuler</button>
            </div>
            </form>
        </div>
    </div>
